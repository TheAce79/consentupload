    ...
    public static void SaveToCsv(IEnumerable<ClinicPdfClientRecord> records, string targetCsvPath)
    {
        ...
        try
        {
            ...
            }))
            {
                ...
                csv.WriteField("ClientIdStatus"); csv.WriteField("FirstName"); csv.WriteField("LastName"); csv.WriteField("MiddleName"); csv.WriteField("ErrorDetails"); csv.WriteField("BestMatch"); csv.WriteField("Phone"); csv.WriteField("Email"); csv.WriteField("VaccineType"); csv.NextRecord();
