...
namespace ConsentSyncCore.Services
{
    ...
    ///     │     │     ├── 1_Scan_FileRose\     ← drop {ClientId}.pdf here
    ...
    ///           ├── 1_To_Upload\
    ///           │     ├── 1 Consent Upload\
    ///           │     └── 2 File Rose Upload\  ← extracted files land here
    ///           └── 2_Error\
    /// </summary>
    public static class WorkspaceInitializer
    {
        public static void EnsureAllFoldersExist()
        {
            ...
            try
            {
                ...
                CreateFolder(pdf.GetFileRoseScanPath(), "Pdf › 4 FileRose Extraction › 1_Scan_FileRose", errors);
                CreateFolder(pdf.GetFileRoseErrorPath(), "Pdf › 4 FileRose Extraction › 3_Error", errors);
